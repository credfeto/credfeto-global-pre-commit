...
1. Add or update a test in `scripts/acceptance-test` that covers the linter.
...
Remove the corresponding test(s) from `scripts/acceptance-test` so the test count stays accurate.
